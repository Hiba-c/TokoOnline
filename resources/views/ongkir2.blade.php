...
<body class="bg-gray-200 min-h-screen flex items-center justify-center p-4">
    ...
    <div class="bg-white p-8 rounded-xl shadow w-full max-w-2xl">
        <h1 class="text-3xl font-bold text-center text-gray-800 mb-8">Perhitungan Ongkos Kirim (V2)</h1>
        ...
        <!-- Dropdown Kota / Kabupaten -->
            ...
            <div>
            <label for="courier" class="block text-sm font-medium text-gray-700 mb-1">Pilihan Kurir</label>
             <select name="courier" id="courier" class="mt-1 block w-full pl-3 pr-10 py-2 text-base bg-gray-200 border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md shadow-sm disabled:bg-gray-50 disabled:cursor-not-allowed">
